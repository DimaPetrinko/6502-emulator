...
private:
	#include "Cpu/Instructions/Sta/Definitions.h"
	#include "Cpu/Instructions/Stx/Definitions.h"
	#include "Cpu/Instructions/Sty/Definitions.h"
	#include "Cpu/Instructions/Lda/Definitions.h"
